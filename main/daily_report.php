...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Ledger Report
			</div>
			<ul class="breadcrumb">
...
</select>Day : <input type="text" style="width: 223px; height:44px;" name="d1" class="tcal" value="" /> 
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr><th>#</th>
			...
			<th width="18%" style="color: #009fff"> Amount Paid </th>
	...
	<tbody>
			...
			<?php
				...
				$result = $db->prepare("SELECT * FROM ledger WHERE DATE(ledger.created_at) = :a ORDER by ledger_id DESC ");
	...
	<thead>
		<tr>
			...
			<?php
				...
				echo "Kshs <h3>".formatMoney($total_amount, true)."</h3>";
