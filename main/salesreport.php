...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				$result = $db->prepare("SELECT * FROM sales WHERE DATE(sales.created_at) >= ? AND DATE(sales.created_at) <= ? ORDER by transaction_id DESC ");
	...
	<thead>
		<tr>
			...
			<?php
				...
				$results = $db->prepare("SELECT sum(amount) FROM sales WHERE DATE(sales.created_at) >= :a AND DATE(sales.created_at) <= :b");
