...
?>
	...
	<table border="0" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="50%">
		<thead>
			<tr>
				<th> Product Code </th>
				<th> Product Name </th>
	...
	<!-- <br><div style="font-size: 20px; color: #222222;">
Powered by: <strong style="font-size: 15px; color: #0609FF;"><i>AllTime Technologies</i>, 0707-739-013</strong></div> -->
	</div>
	</div>
	</div>
	</div>
<div class="pull-right" style="margin-right:100px;">
		<button onclick="printData()" class="btn btn-primary btn-lg pull-right">Print</button>
		</div>	
</div>
</div>
