...
<?php 
			...
			Number of users: <font color="green" style="font:bold 22px 'Aleo';"><?php echo $rowcount;?></font>
			</div>
</div>
<input type="text" name="filter" style="height:45px;" id="filter" placeholder="Search Customer..." autocomplete="off" />
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td>
				<?php
				if($row['status'] == '1'){ ?>
				<!-- <a  title="Click To Edit User" rel="facebox" href="edituser.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit </button></a>  -->
		...
		<?php }else{ ?>
			<button class="btn btn-info btn-mini">Account Disabled</button>
		<?php } ?>
		</td>
			</tr>
			<?php
